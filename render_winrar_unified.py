...
import argparse
ap = argparse.ArgumentParser(description="WinRAR xianyu cover (unified)")
ap.add_argument("--version", default="v7.23", help="empty string hides version")
VER = ap.parse_args().version.strip()
...
out = pathlib.Path("D:/X".replace("X", "\u95f2\u9c7c") + "/WinRAR " + VER_PREFIX + "解压缩工具")
