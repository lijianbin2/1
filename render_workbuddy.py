...
out = pathlib.Path('D:/闲鱼/WorkBuddy智能体实战，打造个人AI效率系统')
...
draw.text((BORDER+40, H-BORDER-bar_h-36), 'WorkBuddy · 37课时 · 智能体实战 · 即学即用', fill=GRAY, font=get_font(22))
...
draw.text((BORDER+40, BORDER+28+56), '37课时 · 6大模块 · 智能体全场景覆盖', fill=GRAY, font=sub_font)
# badge right
badge2='37节'
...
mods=[
    ...
    ('模块6 办公实战', '29-37', ['小程序开发', 'PPT整理成稿', '数据分析报告', '写作周报', '剪辑实战', '飞书双工作台'], (225,29,72)),
];
...
draw.text((BORDER+40, BORDER+28+56), '从入门到实战，6步打通个人效率系统', fill=GRAY, font=sub_font)
# 6 points left
points=[
