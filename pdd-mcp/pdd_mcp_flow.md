# 拼多多 MCP 全流程 - 存档 v1.27 (2026-09-03)

> 用 MCP 边看边改验证通过：15:53:30-15:55:19 109s 完整跑通 === all done v1.27 ===
...
| goHome | 回首页 | 循环10次：isHome=首页+个人中心 且非共200元券；否则 tap 30,380 / 128,2640 + robustBack | MainFrameActivity |
| s1 省钱月卡 | 直点优先 | 896,750 896,784 640,650 依次点，离首页即成功，误进商品 pressBack | s1 直点 896,750 已离开首页 成功 |
...
| 结束 | 回顶部 | swipeToTop | === all done v1.27 === |
...
isHome = text首页 && text个人中心 && !textContains共200元券 || dumpsys MainFrameActivity
...
日志标志：pdd v1.27, s1 直点, s3 坐标已离开首页, s6 开学消费券, all done
